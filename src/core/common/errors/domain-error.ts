...
export const VERIFICATION_RECORD_ERROR = {
  ...
  RECORD_ALREADY_CONSUMED: 'VERIFICATION_RECORD_ALREADY_CONSUMED', // 新增
  RECORD_NOT_YET_VALID: 'VERIFICATION_RECORD_NOT_YET_VALID', // 新增
  ...
  UPDATE_FAILED: 'VERIFICATION_RECORD_UPDATE_FAILED', // 新增：修复 service 中的引用错误
  STATUS_NOT_ALLOWED: 'VERIFICATION_RECORD_STATUS_NOT_ALLOWED', // 新增：状态不允许操作
  CONSUMPTION_FAILED: 'VERIFICATION_RECORD_CONSUMPTION_FAILED',
  REVOCATION_FAILED: 'VERIFICATION_RECORD_REVOCATION_FAILED',
  VERIFICATION_INVALID: 'VERIFICATION_RECORD_VERIFICATION_INVALID', // 新增：验证无效（类型不匹配等）
  INVALID_PARAMS: 'VERIFICATION_RECORD_INVALID_PARAMS', // 新增：无效参数
  INVALID_TYPE: 'VERIFICATION_RECORD_INVALID_TYPE', // 新增：无效类型
} as const;
