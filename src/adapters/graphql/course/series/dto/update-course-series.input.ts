...
export class UpdateCourseSeriesInput {
  ...
  @Field(() => Int, { nullable: true, description: '课程目录 ID' })
  @IsOptional()
  ...
  @Field(() => String, { nullable: true, description: '开班起始日期 (YYYY-MM-DD)' })
  @IsOptional()
  @IsDateString({ strict: true }, { message: '起始日期格式应为 YYYY-MM-DD' })
  startDate?: string;

  @Field(() => String, { nullable: true, description: '开班结束日期 (YYYY-MM-DD)' })
  @IsOptional()
