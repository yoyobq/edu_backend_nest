  ...
  async createVerificationRecord(
    ...
    try {
      const result = await this.createVerificationRecordUsecase.execute({
        ...
        payload: input.payload ? (JSON.parse(input.payload) as Record<string, unknown>) : undefined,
      ...
      return {
        ...
        data: {
          ...
          payload: result.record.payload ? JSON.stringify(result.record.payload) : null,
