// src/adapters/api/graphql/identity-management/learner/learner.resolver.ts
...
export class LearnerResolver {
  ...
  async updateLearner(
    ...
    const result = isManager
      ? await this.updateLearnerByManagerUsecase.execute({
          accountId,
          input: {
            id: input.learnerId,
      ...
      : await this.updateLearnerByCustomerUsecase.execute({
          accountId,
          input: {
            id: input.learnerId,
            customerId: input.customerId,
  ...
  async deleteLearner(
    ...
    await this.deleteLearnerUsecase.execute({
