...
import { ManagerType } from '@src/adapters/api/graphql/account/dto/identity/manager.dto';
...
import { ListManagersInput } from '@src/adapters/api/graphql/identity-management/manager/dto/manager.input.list';
import { ListManagersOutput } from '@src/adapters/api/graphql/identity-management/manager/dto/managers.list';
